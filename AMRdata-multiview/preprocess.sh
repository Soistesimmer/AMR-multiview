...
python a2b.py $base_dir/train.sent $base_dir/$version/train.tok.sent.bpe $base_dir/train.align $base_dir/train.al2 $base_dir/$version/train.align $base_dir/$version/train.al2 False True
python a2b.py $base_dir/dev.sent $base_dir/$version/dev.tok.sent.bpe $base_dir/dev.align $base_dir/dev.al2 $base_dir/$version/dev.align $base_dir/$version/dev.al2 False True
python a2b.py $base_dir/test.sent $base_dir/$version/test.tok.sent.bpe $base_dir/test.align $base_dir/test.al2 $base_dir/$version/test.align $base_dir/$version/test.al2 False True

#echo "Making relation label.."
#python get_relation_mask.py $base_dir/$version/train.align $base_dir/$version/train.ali2 $base_dir/gq_relation_vocab $base_dir/$version/train.rm
#python get_relation_mask.py $base_dir/$version/dev.align $base_dir/$version/dev.ali2 $base_dir/gq_relation_vocab $base_dir/$version/dev.rm
