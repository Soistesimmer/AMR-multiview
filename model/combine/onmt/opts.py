...
def preprocess_opts(parser):
    ...
    group.add('--train_stgt', '-train_stgt', required=True,
              help="Path to the reconstructed training target data")
    group.add('--train_structure', '-train_structure', required=True,
              help="Path to the training structure data")
    group.add('--train_mask', '-train_mask', required=True)
    group.add('--train_relation', '-train_relation', required=True)
    group.add('--valid_src', '-valid_src', required=True,
              help="Path to the validation source data")
    group.add('--valid_tgt', '-valid_tgt', required=True,
              help="Path to the validation target data")
    group.add('--valid_stgt', '-valid_stgt', required=True,
              help="Path to the reconstructed validation target data, keep for easy coding")
    group.add('--valid_structure', '-valid_structure', required=True,
              help="Path to the validation structure data")
    group.add('--valid_mask', '-valid_mask', required=True)
    group.add('--valid_relation', '-valid_relation', required=True)
    ...
    group.add('--relation_vocab_size', '-relation_vocab_size', type=int, default=30,
              help="Size of the relation vocabulary")
    ...
    group.add('--seed', '-seed', type=int, default=3435,
              help="Random seed")
    group.add('--abundancy', '-abundancy', type=int, default=10, help="abundancy of random reconstruct inputs")
...
def train_opts(parser):
    ...
    # second decoder**
    group.add('--ratio', '-ratio', type=float, default=1., help="The ratio balancing original decoder and the new one.")
    group.add('--ratio2', '-ratio2', type=float, default=1., help="The ratio balancing biaffine module and the others.")
