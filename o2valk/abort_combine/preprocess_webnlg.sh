...
python3 ./preprocess.py -train_src $train_test_data_dir/train-webnlg-all-notdelex-src-nodes.txt \
                        ...
                        -train_stgt $train_test_data_dir/train-webnlg-all-notdelex-src-nodes.txt \
                        -train_mask $train_test_data_dir/train.mask \
                        ...
                        -valid_stgt $train_test_data_dir/dev-webnlg-all-notdelex-src-nodes.txt \
                        -valid_mask $train_test_data_dir/dev.mask   \
