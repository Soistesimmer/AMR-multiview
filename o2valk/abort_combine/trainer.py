...
class Trainer(object):
    ...
    def train(self, train_iter_fct, valid_iter_fct, train_steps, valid_steps, ratio, ratio2):
        """
    ...
    def validate(self, valid_iter):
        ...
        for batch in valid_iter:
            ...
            outputs, attns = self.model(src, tgt, None, structure, None, src_lengths)
    ...
    def _gradient_accumulation(self, true_batchs, normalization, total_stats,
        ...
        for batch in true_batchs:
            ...
            if self.grad_accum_count == 1:
                self.model.zero_grad()
            outputs, attns, s_outputs, s_attns, p = \
                self.model(src, tgt, stgt, structure,mask, src_lengths)

            # 3. Compute loss in shards for memory efficiency.
            batch_stats = self.train_loss.sharded_compute_loss(
                batch, (outputs, s_outputs), stgt, self.shard_size, normalization, ratio1=1-ratio-ratio2, ratio2=ratio)
            loss = p * ratio2
            loss.backward()
