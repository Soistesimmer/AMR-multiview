...
def make_features(batch, side):
    ...
    """
    assert side in ['src', 'tgt', 'structure', 'mask', 'stgt', 'relation']
...
def get_relation_fields(fields=None):
    if fields is None:
        fields={}
...
def get_fields():
    ...
    fields=get_relation_fields(fields)
...
def build_dataset(fields,
    ...
    dataset = Dataset(fields, src_examples_iter, tgt_examples_iter, stgt_examples_iter, structure_examples_iter,mask_examples_iter, relation_examples_iter,
...
class Dataset(torchtext.data.Dataset):
    def __init__(self, fields, src_examples_iter, tgt_examples_iter, stgt_examples_iter, structure_examples_iter, mask_examples_iter, relation_examples_iter,
                 src_seq_length=0, tgt_seq_length=0,
                 use_filter_pred=True):
        ...
        if tgt_examples_iter is not None and structure_examples_iter is not None and mask_examples_iter is not None and relation_examples_iter is not None:
            ...
            out_fields = get_relation_fields(out_fields)
        else:
