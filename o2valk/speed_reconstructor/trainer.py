...
class Trainer(object):
    ...
    def train(self, train_iter_fct, valid_iter_fct, train_steps, valid_steps, ratio=1.):
        """
        ...
        logger.info('Speed spy begin at %f..'%start_time)
        ...
        end_time=time.time()
        logger.info('Speed spy end at %f..'%end_time)
        logger.info('Speed last time(s): %f..'%(end_time-start_time))
        logger.info('Speed per step(s): %f..' % ((end_time - start_time)/train_steps))
        return total_stats
    ...
    def validate(self, valid_iter):
        ...
        for batch in valid_iter:
            ...
            outputs, attns = self.model(src, tgt, None, structure, src_lengths)
    ...
    def _gradient_accumulation(self, true_batchs, normalization, total_stats,
        ...
        for batch in true_batchs:
            ...
            batch_stats = self.train_loss.sharded_compute_loss(
                batch, (outputs, s_outputs), stgt, self.shard_size, normalization, ratio=ratio)
