...
def make_features(batch, side):
    ...
    """
    assert side in ['src', 'tgt', 'structure', 'mask', 'relation']
...
def build_dataset(fields,
    ...
    dataset = Dataset(fields, src_examples_iter, tgt_examples_iter, structure_examples_iter,mask_examples_iter, relation_examples_iter,
...
class Dataset(torchtext.data.Dataset):
    def __init__(self, fields, src_examples_iter, tgt_examples_iter, structure_examples_iter, mask_examples_iter, relation_examples_iter,
                 src_seq_length=0, tgt_seq_length=0,
        ...
        if tgt_examples_iter is not None and structure_examples_iter is not None and mask_examples_iter is not None and relation_examples_iter is not None:
            examples_iter = (_join_dicts(src, tgt, structure, mask, relation) for src, tgt, structure, mask, relation in
                             zip(src_examples_iter, tgt_examples_iter, structure_examples_iter, mask_examples_iter, relation_examples_iter))
