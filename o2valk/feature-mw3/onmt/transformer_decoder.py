...
class TransformerDecoderLayer(nn.Module):
    def __init__(self, d_model, heads, d_ff, dropout):
        ...
        self.feed_forward = PositionwiseFeedForward(d_model*2, d_ff, d_model, dropout)
    ...
    def forward(self, inputs, memory_bank, src_pad_mask, tgt_pad_mask, z,
        ...
        mid, attn = self.context_attn(memory_bank, memory_bank, query_norm,
                                      ...
                                      layer_cache=layer_cache,
                                      type="context")
        output = self.feed_forward(torch.cat((self.drop(mid) + query,z)))
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, z, step=None):
        """
